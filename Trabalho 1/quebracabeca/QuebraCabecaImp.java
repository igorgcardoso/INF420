...
public class QuebraCabecaImp implements QuebraCabeca {
    ...
    public void setTab(int[][] aux) throws Exception {
        ...
        if (aux.length != 3 && aux[0].length != 3) throw new Exception("Tamanho incompatï¿½vel!");
    ...
    public void move(int linha1, int col1, int linha2, int col2) throws Exception {
        ...
        if (linha2 < 0 || linha2 > 2) throw new Exception("Fora de dimensao!");
        if (col1 < 0 || col1 > 2) throw new Exception("Fora de dimensao!");
        if (col2 < 0 || col2 > 2) throw new Exception("Fora de dimensao!");
        if (tab[linha1][col1] != VAZIO) throw new Exception("Nao eh a posicao do vazio!");
    ...
    public List<Posicao> getMovePossiveis() {
        List<Posicao> lista = new ArrayList<>(2);
