...
public class ServidorImp implements Servidor {
    ...
    /**
     * Reinicia o servidor com a configuracao original
     */
    @Override
    ...
    private void exibeResultado() {
        ...
        TabuleiroOthelo tg = (TabuleiroOthelo) tabuleiro;
        int linha = tg.win_r1;
        int col = tg.win_c1;
        int il = 0;
        ...
        visao.setStatus("Fim");
        vencedor = (byte)tabuleiro.vencedorNum();
        perdedor =  tabuleiro.oponente(vencedor);
        visao.setMensagem("Venceu o jogador " + nomes[vencedor] + ", Cor: " + tabuleiro.vencedorCor()+ " "+tabuleiro.numPecas(vencedor)+" X "+ tabuleiro.numPecas(perdedor) );
     }
    ...
    final class Server extends Thread {
        ...
        private void joga() {
            ...
            try {
                ...
                pai.getVisao().setMensagem("Esperando jogador "+Tabuleiro.cor[0] +" em " + oHost + "/" + porta);
                ...
                pai.getVisao().setMensagem("Esperando jogador "+Tabuleiro.cor[1] +" em " + oHost + "/" + porta);
                ...
                for (int i = 0;; i++) {
                    ...
                    getVisao().resetTimer();
                    System.out.println("Esperando " + nomes[j] + "-" + Tabuleiro.cor[j]);
                    try {
                        linhaLida = cinput[j].readLine();
                        System.out.println("linha: " + linhaLida);
